# FabScan v0.5.11 - Camera Calibration UI / Follow Feed

v0.5.11 builds on the v0.5.10 camera robustness work and adds two small Camera Calibration usability fixes.

## What changed in v0.5.11

- Camera Calibration Status panel is now taller/fixed-height so live Line center status wrapping does not resize the layout.
...
## Suggested line-follow settings from v0.5.9/v0.5.11

```text
Mode: Line center
Step: 0.050
Feed: 5.0 units/min to start
