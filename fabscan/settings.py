...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "camera_width": 800,
    "camera_height": 600,
    "camera_stream_max_fps": 20.0,
    "camera_preview_max_fps": 10.0,
    "camera_linuxcnc_safe_preview": False,
    "camera_profile_preview": False,
    ...
    "camera_calibration_show_crosshair": True,
    "camera_calibration_show_dot_marker": True,
    ...
    "camera_follow_feed_units_per_min": 5.0,
    "camera_follow_settle_ms": 150,
    "camera_follow_max_heading_change_degrees": 70.0,
    "camera_follow_corner_pause_enabled": True,
    "camera_follow_corner_angle_degrees": 55.0,
    "camera_follow_corner_assist_enabled": True,
    "camera_follow_corner_lookahead_steps": 5,
    "camera_follow_max_correct": 0.050,
    "camera_follow_deadband": 0.003,
    "camera_follow_gain": 0.50,
    "camera_follow_stabilize_enabled": True,
    "camera_follow_filter_offset_alpha": 0.35,
    "camera_follow_filter_angle_alpha": 0.25,
    "camera_follow_sanity_angle_degrees": 30.0,
    "camera_follow_min_confidence": 45.0,
    "camera_follow_direction": "Y+",
